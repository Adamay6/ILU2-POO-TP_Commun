...
public class Restaurant  {
	...
	public static class Table extends EntiteReservable<FormulaireRestaurant>{
		...
		public boolean compatible(FormulaireRestaurant form) {
			boolean ret = form.getNombrePersonnes() == nbChaises || form.getNombrePersonnes() == nbChaises-1;
		...
		public Reservation reserver(FormulaireRestaurant form){
			...
			return new ReservationRestaurant(form.getJour(),form.getMois(),form.getNumService(),form.getNombrePersonnes());
